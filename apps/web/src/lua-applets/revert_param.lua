-- Bundled with ArduConfigurator (GPL-3.0-only).
-- Source: ArduPilot libraries/AP_Scripting/applets/revert_param.lua
-- Upstream: https://github.com/ArduPilot/ardupilot (GPL-3.0-or-later).
-- Unmodified upstream applet except for this 4-line provenance header.
--[[
...
local OTHER_PARAMS = { "INS_GYRO_FILTER", "INS_ACCEL_FILTER", "PTCH2SRV_TCONST", "RLL2SRV_TCONST",
                       "Q_M_SLEW_DN_TIME", "Q_M_SLEW_UP_TIME", "MOT_SLEW_DN_TIME", "MOT_SLEW_UP_TIME"}
