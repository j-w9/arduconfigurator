...
const RANGEFINDER_TYPE_OPTIONS: ParameterValueOption[] = [
  ...
  { value: 8, label: 'LightWare Serial' },
  { value: 9, label: 'Bebop' },
  { value: 10, label: 'MAVLink' },
  { value: 11, label: 'USD1 Serial' },
  { value: 12, label: 'LeddarOne' },
  { value: 13, label: 'MaxbotixSerial' },
  { value: 14, label: 'TeraRanger I2C' },
  { value: 15, label: 'LidarLiteV3-I2C' },
  { value: 16, label: 'VL53L0X / VL53L1X' },
  { value: 17, label: 'NMEA' },
  { value: 18, label: 'WASP-LRF' },
  { value: 19, label: 'Benewake TF02' },
  { value: 20, label: 'Benewake TFmini-Serial' },
  { value: 21, label: 'LidarLiteV3HP' },
  { value: 22, label: 'PWM (2)' },
  { value: 23, label: 'BlueRobotics Ping' },
  { value: 24, label: 'DroneCAN' },
  { value: 25, label: 'Benewake TFmini-I2C' },
  { value: 26, label: 'Lanbao PSK-CM8JL65-CC5' },
  { value: 27, label: 'Benewake TF03' },
  { value: 28, label: 'VL53L1X-ShortRange' },
  { value: 29, label: 'LeddarVu8-Serial' },
  { value: 30, label: 'HC-SR04' },
  { value: 31, label: 'GYUS42v2' },
  { value: 32, label: 'MSP' },
  { value: 33, label: 'USD1 CAN' },
  { value: 34, label: 'Benewake CAN' },
  { value: 35, label: 'TeraRanger Serial' },
  { value: 36, label: 'Lua Scripting' },
  { value: 37, label: 'NoopLoop TOFSense' },
  { value: 38, label: 'NoopLoop TOFSense CAN' },
  { value: 39, label: 'NRA24 CAN' },
  { value: 40, label: 'NoopLoop TOFSenseF I2C' },
  { value: 41, label: 'JRE Serial' },
  { value: 42, label: 'Ainstein LR-D1' },
  { value: 43, label: 'RDS02UF' },
  { value: 44, label: 'Hexsoon Radar' },
  { value: 45, label: 'LightWare-GRF' },
  { value: 46, label: 'Benewake TFS20L' },
