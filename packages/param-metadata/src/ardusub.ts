...
export const ardusubMetadata: FirmwareMetadataBundle = {
  ...
  parameters: {
    ...
    LOG_DISARMED: { id: 'LOG_DISARMED', label: 'Log While Disarmed', description: 'Continue logging while the sub is disarmed.', category: 'logging', minimum: 0, maximum: 3, options: LOG_DISARMED_OPTIONS }
  },
  setupSections: [
    {
      id: 'link',
