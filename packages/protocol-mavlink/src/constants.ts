...
export const MAVLINK_MESSAGE_IDS = {
  ...
  LOG_DATA: 120,
  LOG_REQUEST_END: 122,
  /** GCS → vehicle: erase all dataflash logs. Destructive and irreversible. */
  LOG_ERASE: 121,
...
export const MAVLINK_MESSAGE_CRCS: Record<number, number> = {
  ...
  // crc_extra 237 (MAVLINK_MSG_ID_LOG_ERASE_CRC, common dialect).
  [MAVLINK_MESSAGE_IDS.LOG_ERASE]: 237,
...
export const MAVLINK_PAYLOAD_LENGTHS: Record<number, number> = {
  ...
  [MAVLINK_MESSAGE_IDS.LOG_ERASE]: 2,
